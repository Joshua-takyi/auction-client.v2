    ...
    <div className="min-h-screen font-sans pt-24 pb-20">
      <div className="container-lux mx-auto px-6">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20 border-dashed border-border">
          ...
          <div className="text-center py-20 border border-dashed border-border bg-gray-50/30">
            <p className="mb-6 tracking-wide">Your collection is empty.</p>
            <Link
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {products.length > 0 &&
              products.map((product: any) => (
                <div
                  key={product.id}
                  className="group relative p-4 border transition-colors"
                >
                  <div className="relative aspect-square overflow-hidden bg-muted/10 mb-4">
                    ...
                    <div className="absolute top-2 right-2">
                      <span
                        className={`text-[8px] uppercase tracking-widest px-2 py-1 backdrop-blur-md border ${product.status === "approved"
                  ...
                  <div className="flex flex-col gap-2">
                    <Link
                      href={`/sellers/products/auction/${product.id}`}
